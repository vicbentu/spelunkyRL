# 1st Again, try only bombs
# 2nd Only bomb input, penalized for click when can't throw bomb | restarted train from 640k steps
...
if __name__ == "__main__":
    ...
    env = VecNormalize(env, norm_obs=True, norm_reward=True, clip_obs=15.)
    # env = VecNormalize.load(r"C:\TFG\Project\SpelunkyRL\Spelunky 2\Mods\Packs\spelunkyRL\testing\train\23-04-25\models\ppo_spelunky_vecnormalize_640000_steps.pkl", env)
    ...
    # model  = PPO.load(
    #     path = r"C:\TFG\Project\SpelunkyRL\Spelunky 2\Mods\Packs\spelunkyRL\testing\train\23-04-25\models\ppo_spelunky_640000_steps.zip",
    #     env=env,
    #     verbose=2,
    #     device="cuda",
    #     n_steps=TIMESTEPS,
