...
if __name__ == "__main__":
    ...
    env = VecNormalize.load(r"C:\TFG\Project\SpelunkyRL\Spelunky 2\Mods\Packs\spelunkyRL\testing\train\23-04-25\models\ppo_spelunky_vecnormalize_960000_steps.pkl", env)

    # when testing
    env.training = False
    env.norm_reward = False

    model_path = r"C:\TFG\Project\SpelunkyRL\Spelunky 2\Mods\Packs\spelunkyRL\testing\train\23-04-25\models\ppo_spelunky_960000_steps.zip"
    model = PPO.load(
        model_path,
        env=env,
