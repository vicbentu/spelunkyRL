...
# 4-> added penalization for jumping, changed gamma to 0.97
# Run from latest model 29 #3
# Added clippping
# Jump penalization was too high
...
if __name__ == "__main__":
    ...
    checkpoint_callback = CheckpointCallback(
        ...
        # save_path=r"testing\train\2025-04-30\models4",
        save_path=r"testing\train\2025-04-30\models5",
